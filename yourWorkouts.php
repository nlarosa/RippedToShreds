...
$users = fetchUsers();
$workouts = fetchWorkoutsByUser( $_SESSION['user'] );

if( isset($_SESSION['id']) && (!empty($_POST['weight']) || !empty($_POST['height']) || !empty($_POST['age']) || !empty($_POST['dailyCalories'])) )
{
	updateWeight( $_SESSION['user'], $_POST['weight'] );
	updateHeight( $_SESSION['user'], $_POST['height'] );
	updateAge( $_SESSION['user'], $_POST['age'] );
	updateCalories( $_SESSION['user'], $_POST['dailyCalories'] );
				...
				<li class="active" id="Tab">
					<div class="row">
						<div class="twelve columns" align="center"> 
							...
							<dl class="tabs pill">
								<dd><a href="yourAccount.php">Personal Details</a></dd>
								<dd class="active"><a href="yourWorkouts.php">Your Workouts</a></dd>
							</dl>
							<ul class="tabs-content">
								<li class="active" id="Tab">
									<div class="row">
